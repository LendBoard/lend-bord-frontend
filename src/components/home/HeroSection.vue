...
<template>
    <main>
        <div class="home-width">
            <img class="bgimg" src="/images/home-bg-3.jpg" alt="">
            <div class="text">
                <div class="container">
                    <div class="title">
                        <div>
                            <h3>Connect and Borrow</h3>
                        </div>
                        <!-- <div class="word can">
                            <span>
                                <h3>C</h3>
                ...
                <p class="desc">Peer-to-Peer Lending with Lend Board </p>
                <div class="tabs">
...
.tabs {
    ...
    height: 75px;
    padding: 10px;
    background: rgba(21, 18, 38, 0.01);
    backdrop-filter: blur(6px);
    margin-top: 80px;
    border-radius: 4px;
    border: 1px solid #332e4554;
}
...
.tabs a:nth-child(2) .tab {
    border-right: 2px solid #332e459d;
    border-left: 2px solid #332e459d;
}
